...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-pink-100 dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-pink-200 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md border-shadow:2xl shadow-pink-500">
